...
public class ListeEvents extends BaseForm {
    ...
    public ListeEvents(Resources res) {
        ...
        for (Evenement promo : list) {
            ...
            // addButton(null,promo.getCodeP(),promo.getReduction(),promo.getDated(),promo.getDatef());
            //addButton(placeHolder, promo.getNiveau());
            addButton(placeHolder, promo.getDescription());
    ...
    private void addButton(Image img, String nameT/*, int reduction, String dated, String datef*/) {
